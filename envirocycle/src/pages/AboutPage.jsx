...
export default function AboutPage() {
  return (
    <div className="pt-20 mx-auto md:mx-72">
      {/* Hero banner — left dark column + right image */}
      <div className="relative w-full flex items-stretch">
        {/* Left solid dark column */}
        <div className="w-[30%] bg-white dark:bg-[#0a0e1a] shrink-0" />
        {/* Right image column — drives total height */}
        <div className="flex-1">
          <img src={heroBanner} alt="About Us" className="w-full h-auto block" />
        </div>
        {/* Text box — vertically centered, overlaps both columns */}
